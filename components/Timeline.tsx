      ...
      <div className="grid grid-cols-[repeat(auto-fit,minmax(320px,1fr))] gap-6">
        ...
        <div className="p-7 md:p-8 bg-panel border border-border rounded-[6px] transition-all duration-300 hover:border-accent/25 hover:-translate-y-1 hover:shadow-[0_8px_28px_rgba(0,0,0,0.35)] reveal">
          ...
          <div className="flex flex-wrap gap-2 mt-3.5">
            <span className="font-mono text-[10px] bg-slate-800 border border-slate-600 text-slate-300 py-1 px-2.5 rounded-[3px] tracking-[1px]">OWASP Top 10</span>
            <span className="font-mono text-[10px] bg-slate-800 border border-slate-600 text-slate-300 py-1 px-2.5 rounded-[3px] tracking-[1px]">Burp Suite</span>
            <span className="font-mono text-[10px] bg-slate-800 border border-slate-600 text-slate-300 py-1 px-2.5 rounded-[3px] tracking-[1px]">HTTP Basics</span>
          </div>
        </div>
        ...
        <div className="p-7 md:p-8 bg-panel border border-border rounded-[6px] transition-all duration-300 hover:border-accent/25 hover:-translate-y-1 hover:shadow-[0_8px_28px_rgba(0,0,0,0.35)] reveal">
          ...
          <div className="flex flex-wrap gap-2 mt-3.5">
            <span className="font-mono text-[10px] bg-slate-800 border border-slate-600 text-slate-400 py-1 px-2.5 rounded-[3px] tracking-[1px]">XSS Labs</span>
            <span className="font-mono text-[10px] bg-slate-800 border border-slate-600 text-slate-400 py-1 px-2.5 rounded-[3px] tracking-[1px]">SQLi Labs</span>
            <span className="font-mono text-[10px] bg-slate-800 border border-slate-600 text-slate-300 py-1 px-2.5 rounded-[3px] tracking-[1px]">PortSwigger</span>
            <span className="font-mono text-[10px] bg-slate-800 border border-slate-600 text-slate-300 py-1 px-2.5 rounded-[3px] tracking-[1px]">CTF</span>
          </div>
        </div>
        ...
        <div className="p-7 md:p-8 bg-panel border border-border rounded-[6px] transition-all duration-300 hover:border-accent2/25 hover:-translate-y-1 hover:shadow-[0_8px_28px_rgba(0,0,0,0.35)] reveal">
          ...
          <div className="flex flex-wrap gap-2 mt-3.5">
            <span className="font-mono text-[10px] bg-slate-800 border border-slate-600 text-slate-400 py-1 px-2.5 rounded-[3px] tracking-[1px]">Responsible Disclosure</span>
            ...
            <span className="font-mono text-[10px] bg-slate-800 border border-slate-600 text-slate-300 py-1 px-2.5 rounded-[3px] tracking-[1px]">Real Target</span>
          </div>
        </div>
        ...
        <div className="p-7 md:p-8 bg-panel border border-border rounded-[6px] transition-all duration-300 hover:border-accent/25 hover:-translate-y-1 hover:shadow-[0_8px_28px_rgba(0,0,0,0.35)] reveal">
          ...
          <div className="flex flex-wrap gap-2 mt-3.5">
            ...
            <span className="font-mono text-[10px] bg-slate-800 border border-slate-600 text-slate-300 py-1 px-2.5 rounded-[3px] tracking-[1px]">Direct Disclosure</span>
          </div>
        </div>
        ...
        <div className="p-7 md:p-8 bg-panel border border-border rounded-[6px] transition-all duration-300 hover:border-accent2/25 hover:-translate-y-1 hover:shadow-[0_8px_28px_rgba(0,0,0,0.35)] reveal">
          ...
          <div className="flex flex-wrap gap-2 mt-3.5">
            <span className="font-mono text-[10px] bg-accent3/10 border border-accent3/20 text-accent3 py-1 px-2.5 rounded-[3px] tracking-[1px]">Hall of Fame ✓</span>
            <span className="font-mono text-[10px] bg-slate-800 border border-slate-600 text-slate-300 py-1 px-2.5 rounded-[3px] tracking-[1px]">Tomorrow Web Design</span>
          </div>
        </div>
        ...
        <div className="p-7 md:p-8 bg-panel border border-border rounded-[6px] transition-all duration-300 hover:border-accent3/25 hover:-translate-y-1 hover:shadow-[0_8px_28px_rgba(0,0,0,0.35)] reveal">
          ...
          <div className="flex flex-wrap gap-2 mt-3.5">
            ...
            <span className="font-mono text-[10px] bg-slate-800 border border-slate-600 text-slate-300 py-1 px-2.5 rounded-[3px] tracking-[1px]">Bug Bounty</span>
            <span className="font-mono text-[10px] bg-slate-800 border border-slate-600 text-slate-300 py-1 px-2.5 rounded-[3px] tracking-[1px]">Pentest</span>
          </div>
        </div>
        ...
        <div className="p-7 md:p-8 bg-panel border border-border rounded-[6px] transition-all duration-300 hover:border-accent3/25 hover:-translate-y-1 hover:shadow-[0_8px_28px_rgba(0,0,0,0.35)] reveal">
          ...
          <div className="flex flex-wrap gap-2 mt-3.5">
            <span className="font-mono text-[10px] bg-slate-800 border border-slate-600 text-slate-300 py-1 px-2.5 rounded-[3px] tracking-[1px]">HackerOne</span>
            <span className="font-mono text-[10px] bg-slate-800 border border-slate-600 text-slate-300 py-1 px-2.5 rounded-[3px] tracking-[1px]">Bugcrowd</span>
