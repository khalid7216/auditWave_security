  ...
  return (
    <section id="contact" className="py-[100px] px-6 md:px-12 max-w-[1200px] mx-auto border-t border-border text-center">
      <div className="max-w-[600px] mx-auto">
        ...
        <a href="mailto:security@khalidsanawer.online" className="inline-flex items-center gap-2 bg-accent text-black font-mono text-[12px] font-bold tracking-[2px] uppercase py-3.5 px-7 rounded-[3px] transition-all duration-200 hover:bg-white hover:-translate-y-0.5 hover:shadow-[0_8px_24px_rgba(0,212,255,0.3)]">
