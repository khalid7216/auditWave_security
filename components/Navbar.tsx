...
export default function Navbar() {
  return (
    <nav className="fixed top-0 left-0 right-0 z-[100] flex justify-between items-center px-6 md:px-12 py-4 bg-[#060a0f]/[0.88] backdrop-blur-md border-b border-border">
      <div className="font-mono text-accent text-sm tracking-[2px]">
        [<span className="text-accent2">KH</span>_SEC]
      </div>
